...
def get_args():
    ...
    parser.add_argument(
        "--selection_method",
        default="ensemble",
        choices=["none", "random", "crest", "single_spread_bn", "random_full"],
    ...
    # others
    parser.add_argument(
        "--use_wandb", default=True, type=parse_bool, const=True, nargs="?"
    )
    parser.add_argument(
        "--selection_method_ensemble",
        default="batch_concate",
        choices=["all", "batch_concate"],
        help="subset selection method",
    )
    parser.add_argument(
        "--ensemble",
    ...
    parser.add_argument(
        ...
        default=0.0,
        type=float,
        help="The corrupt ratio of the dataset",
    )
    parser.add_argument(
        "--select_every", default=1, type=int, help="frequency of selection"
    )

    parser.add_argument(
        "--noise_std", default=0.1, type=float, help="The corrupt ratio of the dataset"
    )
    parser.add_argument(
        "--no_repeat",
        default=False,
